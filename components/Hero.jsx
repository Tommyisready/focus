  ...
  return (
    <section className="h-screen xl:h-[1600px] overflow-x-clip relative">
      ...
      <div className="container mx-auto h-full flex items-center xl:items-start">
        ...
        >
          <h1 className="text-[60px] font-bold tracking-[-0.5px] leading-none max-w-[800px] xl:max-w-max">Boost Ta Productivité Instantanément</h1>
          <p className="max-w-[680px] text-[20px] text-white/80 font-light px-8 xl:px-0 mb-2">
            Rationalisez les tâches et gérez votre temps sans effort grâce à notre plateforme de productivité tout-en-un puissante et intuitive.
          </p>
          <Button btnText="Commencer aujourd'hui" />
        </motion.div>
        {/* img */}
        <motion.div
