    ...
    <section className="py-24 xl:py-32 min-h-[720px] xl:mt-32">
      <div className="container mx-auto flex flex-col justify-center items-center gap-8 xl:gap-16">
        ...
        <motion.div variants={fadeInOnScroll(0.2, 0.6)} initial="hidden" whileInView="visible" className="text-center">
          <h2 className="h2 mb-3">Flux De Travail Unifié</h2>
          <p className="lead">Intégrer avec les meilleures applications pour créer une expérience transparente et connectée</p>
        </motion.div>
        {/* icon list */}
        ...
        <motion.div
          ...
          transition={{ delay: 0.6, duration: 0.4, ease: [0.6, -0.05, 0.01, 0.99], type: "spring", stiffness: 100 }}
        >
          <Button btnText="Voir tous" />
        </motion.div>
      </div>
    </section>
  );
